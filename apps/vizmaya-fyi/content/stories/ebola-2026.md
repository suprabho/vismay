---
title: "A New Ebola is Moving Through a War"
subtitle: "Bundibugyo virus — only the third outbreak of this species ever — is spreading from a gold-mining town in eastern Congo into Kampala. There is no licensed vaccine, no licensed treatment, and no clean live data feed."
...
# A New Ebola is Moving Through a War

*The May 2026 outbreak in eastern Congo is the third ever caused by Bundibugyo virus. The vaccine arsenal built over the last decade is for a different species. The epicentre sits inside the active operational area of three armed groups. Twelve days after the index cluster was confirmed, WHO declared a PHEIC.*
...
*Confirmed cases across DRC and Uganda as of 26 May 2026 — alongside 1,077 suspected cases and roughly 256 suspected deaths.*

The confirmed-case fatality rate is **~14%**. The suspected-case death rate runs **~22%**. The true rate will land somewhere between as cases reclassify — historically Bundibugyo has produced **25%** in Uganda 2007 and **34%** in DRC 2012.

The gap between *confirmed* and *suspected* is the story. It is what testing access looks like in a war.

---

## Three things make this outbreak unlike the last decade
...
## Five countries hold 95% of the history
...
## A new spillover, not a survivor relapse
...
## The data is human-readable, not machine-readable
...
## Twelve days, no vaccine, and a gold-mining town
