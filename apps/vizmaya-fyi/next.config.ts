...
const nextConfig: NextConfig = {
  ...
  transpilePackages: ["@vismay/admin-core", "@vismay/content-source", "@vismay/story-reader", "@vismay/viz-engine", "@vismay/footshorts-viz", "@vismay/f1-viz", "@vismay/starship-viz"],
  async headers() {
    return [
      {
