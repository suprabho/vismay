...
//
// Source of truth: apps/vizmaya-fyi/app/coke-studio/CokeStudioThemePreview.tsx.
// The two copies exist because the admin can't reach across the workspace into
// the consumer app's components directly.
