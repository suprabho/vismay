...
// Ported from apps/vizmaya-fyi/components/share/ShareStatCard.tsx. `statColorVar`
// comes from admin's canvas ThemeProvider copy (same impl as the public site's).

import type { StatColor } from '@vismay/viz-engine'
import { statColorVar } from '@/components/canvas/ThemeProvider'
