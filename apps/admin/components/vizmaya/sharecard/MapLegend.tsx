...
// Ported from apps/vizmaya-fyi/components/share/MapLegend.tsx.
...
function RampLegend({
  ...
  // Stable, render-pure unique id for the gradient (Math.random would be impure
  // during render and isn't SSR-safe).
  const gradientId = `mlg-${useId().replace(/:/g, '')}`
