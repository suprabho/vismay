 ...
 * lists with **bold**, *italic* / _italic_, [links](url), and ![](url) story
 * thumbnails. Not a general parser — it only handles what the recap generator
 * produces, so the admin doesn't need a markdown dependency for one view. Pure
 * render, no client hooks.
 */
