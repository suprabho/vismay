 ...
 * footshorts eval CLI.
 *
 * Run via: pnpm --filter @footshorts/worker eval
...
import { footshortsAdapter } from './adapter';
...
runEval(footshortsAdapter, { since, max, concurrency, judgeModel, outputDir, rerunExtraction }).catch((e) => {
