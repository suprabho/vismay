...
import { getCompetitionPalette, darkenHex } from '@vismay/footshort-viz/web';
import type { FeedCardEntity } from '@shortfoot/shared/schemas';
...
export function FeedCard({
  ...
  return (
    ...
    >
      <div className="shrink-0 grow-0 basis-[60%] overflow-hidden bg-bg">
        {imageUrl ? (
      ...
      <div className="flex flex-1 flex-col gap-3 bg-bg px-6 pt-5 pb-6">
