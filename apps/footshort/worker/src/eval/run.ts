 ...
 * footshort eval CLI.
 *
 * Run via: pnpm --filter @shortfoot/worker eval
...
import { footshortAdapter } from './adapter';
...
runEval(footshortAdapter, { since, max, concurrency, judgeModel, outputDir, rerunExtraction }).catch((e) => {
