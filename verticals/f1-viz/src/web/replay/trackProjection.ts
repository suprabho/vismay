/**
 * Track projection + frame interpolation for the race replay.
 *
 * Ported verbatim from the f1_backend donor (`src/utils/trackProjection.ts`) —
 * pure, framework-free math. Only the type import path changed.
 */
