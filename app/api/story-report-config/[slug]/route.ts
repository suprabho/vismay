/**
 * GET / POST the per-story report.yaml that drives /report and /slides.
 *
 ...
 * happens at read time in `parseReportConfig`, so a malformed save just
 * means the next render sees no overrides rather than a crash.
 */
